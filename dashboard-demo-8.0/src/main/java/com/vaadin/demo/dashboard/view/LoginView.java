...
//        notification.show(Page.getCurrent());
    ...
    private Component buildLoginForm() {
        ...
        loginPanel.addComponent(buildIcon());
        loginPanel.addComponent(new Label());
...
//	    fields.setMargin(marginInfo);
        ...
        fields.addComponents(logo);
	    fields.setComponentAlignment(logo, Alignment.TOP_CENTER);
        return fields;
	}
    ...
    private Component buildLabels() {
        ...
        Label title = new Label("NEW OLEF");
