...
public class ProfilePreferencesWindow extends Window {
    ...
    private final BeanFieldGroup<Utenti> fieldGroup;
    /*
    ...
    private ProfilePreferencesWindow(final Utenti user, final boolean preferencesTabOpen) {
        ...
        fieldGroup = new BeanFieldGroup<Utenti>(Utenti.class);
    ...
    public static void open(final Utenti user, final boolean preferencesTabActive) {
