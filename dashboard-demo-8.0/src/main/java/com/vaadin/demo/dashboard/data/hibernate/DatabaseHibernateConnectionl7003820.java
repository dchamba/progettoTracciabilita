...
public class DatabaseHibernateConnectionl7003820 {
    ...
    public static SessionFactory getSessionFactory() {
    	try {
        	if (configuration == null) {
        		...
        		Properties properties = DatabaseHibernateConnectionUtils.getDatabaseHibernateConnectionProperties("l7003820");
