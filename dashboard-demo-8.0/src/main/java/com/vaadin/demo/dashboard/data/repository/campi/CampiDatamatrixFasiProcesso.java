...
public class CampiDatamatrixFasiProcesso {
	...
	public static String idFaseProcesso = "idFaseProcesso";
	public static String faseProcesso_idFaseProcesso = "faseProcesso.idFaseProcesso";
	public static String idUtente = "idUtente";
	public static String utenteOperatore = "utenteOperatore";
